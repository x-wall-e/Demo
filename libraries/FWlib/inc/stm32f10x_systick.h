...
//cx//#define SysTick_CLKSource_HCLK_Div8    ((u32)0xFFFFFFFB)
//cx//#define SysTick_CLKSource_HCLK         ((u32)0x00000004)

//cx//#define IS_SYSTICK_CLK_SOURCE(SOURCE) (((SOURCE) == SysTick_CLKSource_HCLK) || \
//cx//                                       ((SOURCE) == SysTick_CLKSource_HCLK_Div8))
...
/* Exported macro ------------------------------------------------------------*/
/* Exported functions ------------------------------------------------------- */
void SysTick_CLKSourceConfig_Backup(u32 SysTick_CLKSource);//cx//
