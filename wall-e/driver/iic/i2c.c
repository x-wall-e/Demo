...
/****************************************
函数名：void OLED_IIC_Configuration(void)
说明：IIC初始化
入口：无
出口：无
备注：均输出高电平
*****************************************/
void OLED_IIC_Configuration(void)
{
...
/*********************************
函数名：void OLED_IIC_Send_Byte(u8 txd)
说明：IIC发送一个字节
入口：u8 txd
出口：无
备注：无
...
/********************************
函数名：u8 OLED_IIC_Read_Byte(u8 ack)
说明：IIC读一个字节
