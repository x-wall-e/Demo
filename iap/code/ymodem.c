  ...
  *length = 0;
  ...
  switch (c)
  {
	...
	case STX_64B:
	  ...
	  break;
	case STX_128B:
	case SOH://Compatible with Hyper Terminal
	...
	case STX_512B:
	  ...
	  break;
	case STX_1KB:
	case STX://Compatible with Hyper Terminal
        ...
        case 0://Receive data success
          ...
          switch (packet_length)
          {
            ...
            case - 1://Receive fail
              ...
              return 0;
            /* End of transmission */
            case 0://Receive finish this time
              Send_Byte(ACK);
              file_done = 1;
              break;
            /* Normal packet */
            default://Receive success
